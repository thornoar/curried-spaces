...
#proof[
  ...
  It remains to show that the metric generating the topology of $CC(X,Y)$ is complete. To this end, consider a Cauchy sequence ${f_k}_(k = 1)^oo$ in $CC(X,Y)$. This means that for all $n,m in NN$, there is $N in NN$ such that
  $
